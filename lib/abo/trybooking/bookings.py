...
class Ticket(object):
    ...
    def from_csv_row(cls, row, discount_codes={}):
        ...
        return cls( type = row.ticket_type,
                    price = price,
                    discount = discount,
                    first_name = optional(lambda: capitalise_words(row.ticket_data_attendee_first_name)),
                    last_name = optional(lambda: capitalise_words(row.ticket_data_attendee_last_name)),
